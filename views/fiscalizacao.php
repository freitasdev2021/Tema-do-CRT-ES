...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (hash) {
        // Verifica quais abas existem nesta página (fiscalizamos, equipe)
        if (hash === 'aba-fiscalizamos' || hash === 'aba-equipe') {
            // Suporte para hash no formato #aba-fiscalizamos ou #aba-equipe
            ativarAba(hash.replace('aba-', ''));
        } else {
            ativarAba(hash);
        }
    }
