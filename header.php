...
<nav class="navbar navbar-expand-lg crtbg ">
  <div class="container-fluid">
    <a class="btn btn-outline-secondary text-white" href="#">Espaço do Técnico</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent2">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">Legislação Federal</a></li>
            <li><a class="dropdown-item" href="#">Outros Documentos</a></li>
            <li><a class="dropdown-item" href="#">Resolução CFT</a></li>
            <li><a class="dropdown-item" href="#">Impugnações</a></li>
          </ul>
        </li>
        <!--TRANSPARÊNCIA-->
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">Portal da Transparência</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">Solicitar Registral Profissional</a></li>
            <li><a class="dropdown-item" href="#">Solicitar Registro de Empresa</a></li>
            <li><a class="dropdown-item" href="#">Pesquisar Profissional/Empresa</a></li>
            <li><a class="dropdown-item" href="#">Validar Certidões</a></li>
            <li><a class="dropdown-item" href="#">Validar TRT</a></li>
            <li><a class="dropdown-item" href="#">CAT</a></li>
            <li><a class="dropdown-item" href="#">Denuncia</a></li>
            <li><a class="dropdown-item" href="#">Pesquisar Denuncia</a></li>
          </ul>
        </li>
